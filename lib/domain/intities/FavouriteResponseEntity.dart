...
class FavouriteDataEntity {
  ...
  num? sold;
  List<String>? images;
  List<FavouriteSubcategoryEntity>? subcategory;
  num? ratingsQuantity;
  String? id;
  String? title;
  String? slug;
  ...
  num? price;
  String? imageCover;
  FavouriteCategoryEntity? category;
  FavouriteBrandEntity? brand;
  num? ratingsAverage;
  String? createdAt;
  String? updatedAt;
  num? v;
...
class FavouriteBrandEntity {
  FavouriteBrandEntity({
      this.id, 
      this.name, 
      this.slug, 
      this.image,});
...
class FavouriteCategoryEntity {
  ...
  FavouriteCategoryEntity.fromJson(dynamic json) {
    id = json['_id'];
    name = json['name'];
    slug = json['slug'];
    image = json['image'];
